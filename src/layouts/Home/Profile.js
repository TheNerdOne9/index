...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    Iback&apos;m Diogo, better known as GhostPwner, and I am a cyber security consultant/ethical hacker with around 8 years of experience. During this short career, I have worked in a consultancy company where I audited and helped multiple companies in different sectors to reinforce the cybersecurity of their businesses.    </Text>
    <Text className={styles.description} data-visible={visible} size="l" as="p">
