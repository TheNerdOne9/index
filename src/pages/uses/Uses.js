...
export const Uses = () => {
  return (
    <Fragment>
      ...
      />
      <ServiceContainer className={styles.uses}>
        <ServiceBackground
        ...
        />
        <ServiceSection padding="none" className={styles.section}>
          <ServiceSectionContent>
            <ServiceTextRow width="m">
              <ServiceSectionHeading>Design</ServiceSectionHeading>
              <ServiceSectionText as="div">
                <List>
                  <ListItem>
                    <Link href="https://www.figma.com">Figma</Link> is my primary tool for
                    UI design these days. Made the switch from Sketch in 2020 and haven’t
                    looked back. I’ve also created{' '}
                    <Link href="https://www.figma.com/">a few plugins</Link> that
                    you can install.
                  </ListItem>
                  <ListItem>
        ...
        <ServiceSection padding="none" className={styles.section}>
          <ServiceSectionContent>
            <ServiceTextRow width="m">
              <ServiceSectionHeading>Development</ServiceSectionHeading>
              <ServiceSectionText as="div">
                <List>
                  <ListItem>
                    I use{' '}
        ...
        <ServiceSection padding="none" className={styles.section}>
          <ServiceSectionContent>
            <ServiceTextRow stretch width="m">
              <ServiceSectionHeading>Hardware</ServiceSectionHeading>
              <Table>
                <TableBody>
                  <TableRow>
